...
start_article = raw_input("Enter the name of a Wikipedia article from where to start (ie: 'French Revolution'):  ")
search_term = raw_input("Enter a term or word of search for (ie: 'economic freedoms'): ")

print('''
Awesome!, I will search for the most efficent way to start from the %s Wikipedia article
    ...
    while search_queue: # while the queue isn't empty
        ...
        if not article.title in searched: # only search this article if we haven't already search for
            ...
            if search_term in article.content: # check if article contains the search_term we are looking for
                ...
                print 'I found it!'
                print 'Here is the most efficent way:'
